...
import { getDisplayValues, getValuesFromDisplay, getSuggestions } from '../utils/helpers';
import { BLOCK_CONFIG, BREAKPOINT_DIMENSIONS, CLASS_OPTIONS_MAP } from '../config/blockConfig';
...
const BlockEdit = ( props ) => {
    ...
    const paddingControls = (
        <PanelBody title="Padding Settings" initialOpen={ false }>
            <PaddingControl
                ...
                onChangeBase={ ( value ) => setAttributes( { paddingAllBase: value } ) }
            ...
            <PaddingControl
                ...
                onChangeBase={ ( value ) => setAttributes( { paddingHorizontalBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { paddingHorizontalSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { paddingHorizontalMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { paddingHorizontalLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { paddingHorizontalXl: value } ) }
            />
            <PaddingControl
                label="Vertical"
                subLabel="Padding"
                ...
                onChangeBase={ ( value ) => setAttributes( { paddingVerticalBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { paddingVerticalSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { paddingVerticalMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { paddingVerticalLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { paddingVerticalXl: value } ) }
            />
            <PaddingControl
                label="Top"
                subLabel="Padding"
                ...
                onChangeBase={ ( value ) => setAttributes( { paddingTopBase: value } ) }
            ...
            <PaddingControl
                ...
                onChangeBase={ ( value ) => setAttributes( { paddingRightBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { paddingRightSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { paddingRightMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { paddingRightLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { paddingRightXl: value } ) }
            />
            <PaddingControl
                label="Bottom"
                subLabel="Padding"
                ...
                onChangeBase={ ( value ) => setAttributes( { paddingBottomBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { paddingBottomSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { paddingBottomMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { paddingBottomLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { paddingBottomXl: value } ) }
            />
            <PaddingControl
                label="Left"
                subLabel="Padding"
                ...
                onChangeBase={ ( value ) => setAttributes( { paddingLeftBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { paddingLeftSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { paddingLeftMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { paddingLeftLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { paddingLeftXl: value } ) }
            />
        </PanelBody>
    );
    ...
    const marginControls = (
        <PanelBody title="Margin Settings" initialOpen={ false }>
            <PositiveMarginControl
                ...
                onChangeBase={ ( value ) => setAttributes( { marginAllBase: value } ) }
            ...
            <PositiveMarginControl
                ...
                onChangeBase={ ( value ) => setAttributes( { marginHorizontalBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { marginHorizontalSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { marginHorizontalMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { marginHorizontalLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { marginHorizontalXl: value } ) }
            />
            <PositiveMarginControl
                label="Vertical"
                subLabel="Margin"
                ...
                onChangeBase={ ( value ) => setAttributes( { marginVerticalBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { marginVerticalSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { marginVerticalMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { marginVerticalLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { marginVerticalXl: value } ) }
            />
            <PositiveMarginControl
                label="Top"
                subLabel="Margin"
                ...
                onChangeBase={ ( value ) => setAttributes( { marginTopBase: value } ) }
            ...
            <PositiveMarginControl
                ...
                onChangeBase={ ( value ) => setAttributes( { marginRightBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { marginRightSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { marginRightMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { marginRightLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { marginRightXl: value } ) }
            />
            <PositiveMarginControl
                label="Bottom"
                subLabel="Margin"
                ...
                onChangeBase={ ( value ) => setAttributes( { marginBottomBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { marginBottomSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { marginBottomMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { marginBottomLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { marginBottomXl: value } ) }
            />
            <PositiveMarginControl
                label="Left"
                subLabel="Margin"
                ...
                onChangeBase={ ( value ) => setAttributes( { marginLeftBase: value } ) }
    ...
    const negativeMarginControls = (
        <PanelBody title="Negative Margin Settings" initialOpen={ false }>
            <NegativeMarginControl
                ...
                onChangeBase={ ( value ) => setAttributes( { negativeMarginAllBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { negativeMarginAllSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { negativeMarginAllMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { negativeMarginAllLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { negativeMarginAllXl: value } ) }
            />
            <NegativeMarginControl
                label="Horizontal"
                subLabel="Negative Margin"
                ...
                onChangeBase={ ( value ) => setAttributes( { negativeMarginHorizontalBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { negativeMarginHorizontalSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { negativeMarginHorizontalMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { negativeMarginHorizontalLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { negativeMarginHorizontalXl: value } ) }
            />
            <NegativeMarginControl
                label="Vertical"
                subLabel="Negative Margin"
                ...
                onChangeBase={ ( value ) => setAttributes( { negativeMarginVerticalBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { negativeMarginVerticalSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { negativeMarginVerticalMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { negativeMarginVerticalLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { negativeMarginVerticalXl: value } ) }
            />
            <NegativeMarginControl
                label="Top"
                subLabel="Negative Margin"
                ...
                onChangeBase={ ( value ) => setAttributes( { negativeMarginTopBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { negativeMarginTopSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { negativeMarginTopMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { negativeMarginTopLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { negativeMarginTopXl: value } ) }
            />
            <NegativeMarginControl
                label="Right"
                subLabel="Negative Margin"
                ...
                onChangeBase={ ( value ) => setAttributes( { negativeMarginRightBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { negativeMarginRightSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { negativeMarginRightMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { negativeMarginRightLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { negativeMarginRightXl: value } ) }
            />
            <NegativeMarginControl
                label="Bottom"
                subLabel="Negative Margin"
                ...
                onChangeBase={ ( value ) => setAttributes( { negativeMarginBottomBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { negativeMarginBottomSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { negativeMarginBottomMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { negativeMarginBottomLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { negativeMarginBottomXl: value } ) }
            />
            <NegativeMarginControl
                label="Left"
                subLabel="Negative Margin"
                ...
                onChangeBase={ ( value ) => setAttributes( { negativeMarginLeftBase: value } ) }
                onChangeSm={ ( value ) => setAttributes( { negativeMarginLeftSm: value } ) }
                onChangeMd={ ( value ) => setAttributes( { negativeMarginLeftMd: value } ) }
                onChangeLg={ ( value ) => setAttributes( { negativeMarginLeftLg: value } ) }
                onChangeXl={ ( value ) => setAttributes( { negativeMarginLeftXl: value } ) }
            />
        </PanelBody>
    );
    ...
    return (
        <InspectorControls>
            <PanelBody title="Visibility / Position Classes" initialOpen={ false }>
                <CheckboxControl
                    label="Show Values"
                    checked={ showValues }
