...
function addAriaTextSetting( LinkControl ) {
        return function( props ) {
                const ariaText = props?.value?.attributes?.['data-aria-label-text'] || '';
...
addFilter( 'editor.LinkControl', 'fancy-squares-core-enhancements/aria-link-setting', addAriaTextSetting );
